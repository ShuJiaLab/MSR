function [Data_06_CCD_DN   ,Data_06_CCD_RF     ,...
          ...
          Path_s011Lsample ,Path_s031Lsample ,Path_s033Lsample]= F02_FLFsys_SampleL(                ...
...
%         Data_05_RefInt   = Data_05HRifine;
        ...
        P20_NIP_NumAd_Ray = ceil(Object_31_ZmFOV*Ma_06_Mic^2*tan(asin(NA_01_obj/Ma_06_Mic))*2*P291_NIP_Size_Ext/Data_06_CCD_RF );          % Size of NIP given by ray optics: cone bottom determined by z range 
        P20_NIP_NumAd_Wav = ceil(Theory_41_ResNL*Ma_06_Mic*P292_NIP_Size_Wav                 *P291_NIP_Size_Ext/Data_06_CCD_RF );          % Size of NIP given by ray optics:  
        ...
        P20_NIP_NumAd_Art = ceil(P293_NIP_Size_Num                                           /Data_05_DownRT   *Data_05_RefInt );          % Size of NIP given by the size of nonzero part of PSF(Z_MAX) that is normalized to 65535. 
	...
	if (Flag_MLA_size_Odd)
        ...
        Path_s011Lsample =['P'  ,num2str(Pi_05_cam      *1e6) 'um',...
                           'RF' ,num2str(Data_05_RefInt *1e0)     ,...
                           'DN' ,num2str(Data_05_DownRT *1e0)     ,...     
                           'SPD',num2str(P27_NIP_NumAd_RF)];
        Path_s031Lsample =['P'  ,num2str(Pi_05_cam      *1e6) 'um',...
                           'RF' ,num2str(Data_05_RefInt *1e0)     ,...
                           'DN' ,num2str(Data_05_DownRT *1e0)     ,...     
                           'SPD',num2str(P47_Fou_NumAd_RF)];
        Path_s033Lsample =['P'  ,num2str(Pi_05_cam      *1e6) 'um',...
                           'RF' ,num2str(Data_05_RefInt *1e0)     ,...
                           'DN' ,num2str(Data_05_DownRT *1e0)     ,...     
                           'SPD',num2str(P37_Len_NumPd_RF)];
